...
//
// This is the main calculation unit of the CPU core. It handles all the logic and arithmetic
// operation except for Multiplication and Division.
//
///////////////////////////////////////////////////////////////////////////////////////////////////
...
case class ALU() extends Component {
    ...
    val sra_result = (op1_signed >> shift_value).asBits
